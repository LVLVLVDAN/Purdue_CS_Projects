*****************M/M/1 Single sever queue with vacation ******************
...
Notice 4: The code is based on second part and vacation event is added to that. 



Notice 5: The k is defined in the program and it should be changed for different values. 
