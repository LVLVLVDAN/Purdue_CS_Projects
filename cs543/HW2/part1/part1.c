/* External definitions for a Tandem Queue */
...
void arrive(void)  /* Arrival event function. */
{
    ...
    if (server_status == BUSY) {
        ...
        // a counter for number of arrivals 
...
// modification to support N serises of MM1 queue

/**************a customer is departed from the system when it is serviced in all of N servers  *********/
int i;
